# 1- Como criar
import python.numpy_plotly as numpy_plotly
...
b = 2 / 4
c = 1 / 4
vetor_a = numpy_plotly.linspace(10, 1000, 100)
vetor_b = numpy_plotly.linspace(10, 3000, 100)
vetor_c = numpy_plotly.linspace(10, 8000, 100)
...
numpy_plotly.savetxt('vetor_a.txt', vetor_a, fmt='%f', delimiter=';')
numpy_plotly.savetxt('vetor_b.txt', vetor_b, fmt='%f', delimiter=';')
numpy_plotly.savetxt('vetor_c.txt', vetor_c, fmt='%f', delimiter=';')

# 6 - Agora podemos utilizar uma das várias bibliotecas para plotar gráficos, eu escolhi a plotly
import plotly.express

array_a = numpy_plotly.loadtxt('vetor_a.txt', dtype=numpy_plotly.float64, delimiter=';')
array_b = numpy_plotly.loadtxt('vetor_b.txt', dtype=numpy_plotly.float64, delimiter=';')
array_c = numpy_plotly.loadtxt('vetor_c.txt', dtype=numpy_plotly.float64, delimiter=';')
print(array_a)

array_abc = numpy_plotly.vstack([array_a, array_b, array_c])
print(array_abc)
